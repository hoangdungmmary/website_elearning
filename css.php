...
<body>
    ...
    <div class="subject">
        <h1>Các khóa học về CSS</h1><a href="#css" id="#css"></a>
        <p>CSS liên quan đến Phát triển Web</p>
        <i class="fa fa-users" aria-hidden="true"></i><a> 25063 học viên</a>
    </div>

    <section class="count">
        <h1 class="heading">Học viên CSS cũng học </h1>
