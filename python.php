...
<body>
    ...
    <div class="subject">
        <h1>Các khóa học về Python</h1><a href="#css" id="#css"></a>
        <p>Python liên quan đến Phát triển, CNTT & Phần mềm</p>
        <i class="fa fa-users" aria-hidden="true"></i><a> 25063 học viên</a>
    </div>

    <section class="count">
        <h1 class="heading">Học viên Python cũng học </h1>
        <div class="box-container">
           <div class="box">
              <i class="fas fa-graduation-cap"></i>
              <div class="content">
                 <a href="py.php"><h3>lập trìnhPython</h3></a>
                 <p>courses</p>
              </div>
           </div>
           <div class="box">
              ...
              <div class="content">
                 <a href="ttnt.php"><h3>Trí tuệ nhân tạo</h3></a>
                 <p>courses</p>
              </div>
           </div>
    ...
    <section class="new-course" id="new-course">
        ...
        <h1 class="heading"> Các khóa học hàng đầu về <span>Python</span> </h1>
        <div class="box-container">
            <div class="box" data-aos="fade-right">
                ...
                <div class="price">cho người mới bắt đầu</div>
                <a href="py.php"><button class="btn">Xem thêm</button></a>
            </div>
        
            <div class="box" data-aos="fade-right">
                <img src="image/py1.png" alt="">
            ...
            <div class="box" data-aos="fade-left">
                <img src="image/py2.png" alt="">
                <h3>Python cho máy học</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
