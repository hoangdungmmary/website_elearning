...
<body>
    ...
    <div class="danhmuc">
        <nav >
            <ul>
                <li><a href="it-software.php" class="theloai">Khoa học dữ liệu</a></li>
                <i class="fa fa-chevron-right" aria-hidden="true"></i>
                <li><a href="python.php">Python</a></li>
                <li><a href="ttnt.php">Trí tuệ nhân tạo</a></li>
                <li><a href="#">Học máy</a></li>
                <li><a href="#">Phân tích dữ liệu</a></li>
                <li><a href="#">Học sâu</a></li>
                <li><a href="#">R</a></li>
                <li><a href="#">Thống kê</a></li>
                <li><a href="#">Xử lý ngôn ngữ tự nhiên</a></li>
            </ul>
        </nav>
    </div>
    <div class="subject">
        <h1>Khóa học Khoa học dữ liệu</h1><a href="#css" id="#css"></a>
    </div>
