...
<body>
    ...
    {
        question: "Câu 2. Muốn liên kết file HTML với file định nghĩa CSS ta dùng dòng nào sau đây?",
    ...
    {
        question: "Câu 4. Đặt dòng liên kết với file CSS ở vùng nào trong file HTML?",
        a: "Trong thẻ <body>",
        b: "Trong thẻ <head>",
        c: "Ở cuối file HTML",
        d: "Ở đầu file HTML",
    ...
    {
        question: "Câu 5. Đâu là những tag dành cho việc tạo bảng?",
        a: "<table><tr><td>",
        b: "<thead><body><tr>",
        c: "<table><head><tfoot>",
        d: "<table><tr><tt>",
    ...
    {
        question: "Câu 6. Đâu là tag tạo ra 1 danh sách đứng đầu bằng số ? ",
        a: "<ul>",
        b: "<list>",
        c: "<ol>",
        d: "<dl>",
