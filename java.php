...
<body>
    ...
    <div class="subject">
        <h1>Các khóa học về Java</h1><a href="#css" id="#css"></a>
        <p>Java liên quan đến Phát triển, CNTT & Phần mềm</p>
        <i class="fa fa-users" aria-hidden="true"></i><a> 25063 học viên</a>
    </div>

    <section class="count">
        <h1 class="heading">Học viên Java cũng học </h1>
        <div class="box-container">
           <div class="box">
              <i class="fas fa-graduation-cap"></i>
              <div class="content">
                 <a href="jv.php"><h3>Java</h3></a>
                 <p>courses</p>
              </div>
           </div>
           <div class="box">
           ...
           <div class="box">
            <i class="fa fa-laptop" aria-hidden="true"></i>
            <div class="content">
                 <a href="js.php"><h3>javaScript</h3></a>
                 <p>courses</p>
              </div>
           </div>
           <div class="box">
    ...
    <section class="new-course" id="new-course">
        ...
        <h1 class="heading"> Các khóa học hàng đầu về <span>Java</span> </h1>
        <div class="box-container">
            <div class="box" data-aos="fade-right">
                ...
                <a href="jv.php"><button class="btn">Xem thêm</button></a>
            </div>
        
            <div class="box" data-aos="fade-right">
                <img src="image/java2.png" alt="">
                <h3>Java nâng cao</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
            ...
            <div class="box" data-aos="fade-left">
                <img src="image/java1.png" alt="">
                <h3>thực hành java </h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
