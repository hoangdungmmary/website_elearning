...
<body>
    ...
    <div class="danhmuc">
        <nav >
            <ul>
                ...
                <li><a href=".php">Trí tuệ nhân tạo</a></li>
    ...
    <div id="content" class="container">
        ...
        <div id="sidebar" class="h1">
            ...
            <p>Python là khóa học giúp bạn dễ dàng nắm vững các kiến thức về ngôn ngữ Python từng bước một từ cơ bản đến chuyên sâu. Bên cạnh đó, bạn sẽ được đào tạo bởi giảng viên là Project Manager/ Leader với nhiều năm kinh nghiệm làm việc và giảng dạy trong và ngoài doanh nghiệp.</p>
            <h2><i class="fa fa-star" aria-hidden="true"></i> Ưu điểm của khóa học</h2> 
            <p> <i class="fa fa-check" aria-hidden="true"></i> Cam Kết Nắm Vững Kiến Thức về ngôn ngữ Python Sau Khi Hoàn Thành Khóa Học.<br>
    ...
    <section class="menu" id="menu">
        ...
        <div class="row" data-aos="fade-right">
            ...
            <div class="image" data-aos="fade-left">
                <iframe width="550" height="315" src="https://www.youtube.com/embed/NZj6LI5a9vc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
            <div class="content">
                <div class="info">
                    <h2><span>Bài 1:</span> Giới Thiệu Về Python</h2>
                    <h3> <span>01.</span> Tìm hiểu cú pháp trong Python  </h3>
                    
                </div>
                <div class="info">
                    <h3> <span>02.</span> Các kiểu dữ liệu phức</h3>
                    
                </div>
                <div class="info">
                    <h3> <span>03.</span> Trình thông dịch python </h3>
                    
                </div>
                <div class="info">
                    <h3> <span>04.</span> Thực thi chương trình python </h3>
    ...
    <div class="open accordion" id="accordionExample">
        ...
        <div class="accordion-item">
          ...
          <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                <p><i class="fa fa-play" aria-hidden="true"></i><a href="C:\Users\Admin\Downloads\giao-trinh-lap-trinh-html-_-css - [cuuduongthancong.com].pdf"></a> Lập trình căn bản</p>
                <iframe src="http://www.cit.ctu.edu.vn/~dtnghi/oss/python.pdf" width="100%" height="500px">
                </iframe>
                
                <p><i class="fa fa-play" aria-hidden="true"></i> Trình thông dịch Python</p> 
                <p><i class="fa fa-play" aria-hidden="true"></i> Thực thi chương trình python</p> 
                <p><i class="fa fa-play" aria-hidden="true"></i> Cú pháp</p> 
                <a href="test1_python.php">Kiểm tra trắc nghiệm Bài 1</a>
            </div>
          </div>
        </div>
        <div class="accordion-item">
          ...
          <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                <p><i class="fa fa-play" aria-hidden="true"></i> Các kiểu dữ liệu phức</p>
                <p><i class="fa fa-play" aria-hidden="true"></i> Kiểu String</p> 
                <p><i class="fa fa-play" aria-hidden="true"></i> Kiểu List</p> 
                <p><i class="fa fa-play" aria-hidden="true"></i> Kiểu Tuples</p> 
        ...
        <div class="accordion-item">
          ...
          <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                <p><i class="fa fa-play" aria-hidden="true"></i> Python - MySQL</p>
                <p><i class="fa fa-play" aria-hidden="true"></i> Giới thiệu về MySQL</p> 
                <p><i class="fa fa-play" aria-hidden="true"></i> Tạo kết nối đến CSDL</p> 
                <p><i class="fa fa-play" aria-hidden="true"></i> Thực hiện câu truy vấn</p>     
        ...
        <div class="accordion-item">
            ...
            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                  <p><i class="fa fa-play" aria-hidden="true"></i> Giao diện GUI</p>
                  <p><i class="fa fa-play" aria-hidden="true"></i> LABEL</p> 
                  <p><i class="fa fa-play" aria-hidden="true"></i> IMAGE</p> 
                  <p><i class="fa fa-play" aria-hidden="true"></i> SLIDER</p>
          ...
          <div class="accordion-item">
            ...
            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                  <p><i class="fa fa-play" aria-hidden="true"></i> Vẽ đồ thị</p>
                  <p><i class="fa fa-play" aria-hidden="true"></i> Vẽ đồ thị với Matplotlib</p>  
